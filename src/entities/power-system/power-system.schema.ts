...
// Relations
export const rootsOfPowerRelations = relations(rootsOfPower, ({ one, many }) => ({
...
export const powerSystemsRelations = relations(powerSystems, ({ one, many }) => ({
...
export const powerAbilitiesRelations = relations(powerAbilities, ({ one, many }) => ({
