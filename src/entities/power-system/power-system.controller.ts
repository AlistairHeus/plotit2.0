...
export class PowerSystemController {
  ...
  async createPowerSystem(req: Request, res: Response): Promise<void> {
    ...
    const powerSystem =
      await this.powerSystemService.createPowerSystem(powerSystemData);
  ...
  async getPowerSystems(req: Request, res: Response): Promise<void> {
    ...
    const result =
      await this.powerSystemService.getPowerSystems(powerSystemData);
  ...
  async getPowerSystemsGraph(req: Request, res: Response): Promise<void> {
    const universeId = validateParams<string>(
      req.params.universeId,
      paramsSchema,
    );

    const result =
      await this.powerSystemService.getPowerSystemsGraph(universeId);
  ...
  async getPowerSystemById(req: Request, res: Response): Promise<void> {
    ...
    const powerSystem =
      await this.powerSystemService.getPowerSystemById(powerSystemId);
  ...
  async updatePowerSystem(req: Request, res: Response): Promise<void> {
    ...
    const powerSystem = await this.powerSystemService.updatePowerSystem(
      powerSystemId,
      powerSystemData,
    );
  ...
  async deletePowerSystem(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "PowerSystem deleted successfully" });
  }
  ...
  async deleteRoot(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "Root deleted successfully" });
  }

  // --- powerSubSystems ---
  async createSubSystem(req: Request, res: Response): Promise<void> {
    const data = validateBody<CreatePowerSubSystem>(
      req.body,
      createPowerSubSystemSchema,
    );
  ...
  async updateSubSystem(req: Request, res: Response): Promise<void> {
    const id = validateParams<string>(req.params.id, paramsSchema);
    const data = validateBody<UpdatePowerSubSystem>(
      req.body,
      updatePowerSubSystemSchema,
    );
  ...
  async deleteSubSystem(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "SubSystem deleted successfully" });
  }

  // --- powerCategories ---
  async createCategory(req: Request, res: Response): Promise<void> {
    const data = validateBody<CreatePowerCategory>(
      req.body,
      createPowerCategorySchema,
    );
  ...
  async updateCategory(req: Request, res: Response): Promise<void> {
    const id = validateParams<string>(req.params.id, paramsSchema);
    const data = validateBody<UpdatePowerCategory>(
      req.body,
      updatePowerCategorySchema,
    );
  ...
  async createAbility(req: Request, res: Response): Promise<void> {
    const data = validateBody<CreatePowerAbility>(
      req.body,
      createPowerAbilitySchema,
    );
  ...
  async updateAbility(req: Request, res: Response): Promise<void> {
    const id = validateParams<string>(req.params.id, paramsSchema);
    const data = validateBody<UpdatePowerAbility>(
      req.body,
      updatePowerAbilitySchema,
    );
  ...
  async deleteAbility(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "Ability deleted successfully" });
  }
}
