...
export const updateRootOfPowerSchema = createRootOfPowerSchema.partial().omit({ universeId: true });
...
export const updatePowerSubSystemSchema = createPowerSubSystemSchema.partial().omit({ powerSystemId: true });
