...
export class RaceController {
  ...
  async deleteRace(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "Race deleted successfully" });
  }
  ...
  async createEthnicGroup(req: Request, res: Response): Promise<void> {
    ...
    log.info("Ethnic group created", {
      groupId: group.id,
      raceId,
      operation: "create_ethnic_group",
    });
  ...
  async getEthnicGroupsByRace(req: Request, res: Response): Promise<void> {
    ...
    res
      ...
      .json({
        success: true,
        data: groups,
        message: "Ethnic groups retrieved successfully",
      });
  }
  ...
  async getEthnicGroupById(req: Request, res: Response): Promise<void> {
    ...
    res
      ...
      .json({
        success: true,
        data: group,
        message: "Ethnic group retrieved successfully",
      });
  }
  ...
  async updateEthnicGroup(req: Request, res: Response): Promise<void> {
    ...
    const files =
      req.files && !Array.isArray(req.files) ? req.files : undefined;
    const group = await this.raceService.updateEthnicGroup(
      groupId,
      data,
      files,
    );

    log.info("Ethnic group updated", {
      groupId: group.id,
      operation: "update_ethnic_group",
    });
  ...
  async deleteEthnicGroup(req: Request, res: Response): Promise<void> {
    ...
    log.info("Ethnic group deleted", {
      groupId,
      operation: "delete_ethnic_group",
    });

    res
      .status(200)
      .json({ success: true, message: "Ethnic group deleted successfully" });
  }
}
