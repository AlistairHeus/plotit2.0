...
import {
  ...
  solarSystemQuerySchema,
  updateSolarSystemSchema,
  createStarSchema,
  starQuerySchema,
  updateStarSchema,
  createPlanetSchema,
...
export class CelestialController {
  ...
  async createGalaxy(req: Request, res: Response): Promise<void> {
    ...
    log.info("Galaxy created successfully", {
      id: result.id,
  ...
  async getGalaxies(req: Request, res: Response): Promise<void> {
    ...
    log.info("Galaxies retrieved successfully", {
      count: result.data.length,
      operation: "get_galaxies",
    });
    res
      .status(200)
      .json({
  ...
  async getGalaxyById(req: Request, res: Response): Promise<void> {
    ...
    res
      ...
      .json({
        success: true,
        data: result,
        message: "Galaxy retrieved successfully",
      });
  }
  ...
  async updateGalaxy(req: Request, res: Response): Promise<void> {
    ...
    log.info("Galaxy updated successfully", {
      id: result.id,
      operation: "update_galaxy",
    });
    res
      .status(200)
      .json({
  ...
  async deleteGalaxy(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "Galaxy deleted successfully" });
  }
  ...
  async createSolarSystem(req: Request, res: Response): Promise<void> {
    ...
    log.info("Solar System created successfully", {
      id: result.id,
      operation: "create_solar_system",
    });
    res
      .status(201)
      .json({
  ...
  async getSolarSystems(req: Request, res: Response): Promise<void> {
    ...
    log.info("Solar Systems retrieved successfully", {
      count: result.data.length,
      operation: "get_solar_systems",
    });
    res
      .status(200)
      .json({
  ...
  async updateSolarSystem(req: Request, res: Response): Promise<void> {
    ...
    const files =
      req.files && !Array.isArray(req.files) ? req.files : undefined;
    const result = await this.celestialService.updateSolarSystem(
      id,
      data,
      files,
    );
    log.info("Solar System updated successfully", {
      id: result.id,
      operation: "update_solar_system",
    });
    res
      .status(200)
      .json({
  ...
  async deleteSolarSystem(req: Request, res: Response): Promise<void> {
    ...
    log.info("Solar System deleted successfully", {
      operation: "delete_solar_system",
    });
    res
      .status(200)
      .json({ success: true, message: "Solar System deleted successfully" });
  }
  ...
  async createStar(req: Request, res: Response): Promise<void> {
    ...
    log.info("Star created successfully", {
      id: result.id,
  ...
  async getStars(req: Request, res: Response): Promise<void> {
    ...
    log.info("Stars retrieved successfully", {
      count: result.data.length,
      operation: "get_stars",
    });
    res
  ...
  async updateStar(req: Request, res: Response): Promise<void> {
    ...
    log.info("Star updated successfully", {
      id: result.id,
  ...
  async deleteStar(req: Request, res: Response): Promise<void> {
    ...
    res
      .status(200)
      .json({ success: true, message: "Star deleted successfully" });
  }
  ...
  async createPlanet(req: Request, res: Response): Promise<void> {
    ...
    log.info("Planet created successfully", {
      id: result.id,
  ...
  async getPlanets(req: Request, res: Response): Promise<void> {
    ...
    log.info("Planets retrieved successfully", {
      count: result.data.length,
      operation: "get_planets",
    });
    res
      .status(200)
      .json({
