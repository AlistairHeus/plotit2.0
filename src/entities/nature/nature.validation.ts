...
import { NatureOccurance, NatureType } from "@/entities/nature/nature.types";

export const createNatureSchema = z.object({
  name: z.string().min(1),
  universeId: z.string().uuid(),
  type: z.nativeEnum(NatureType),
  occurance: z.nativeEnum(NatureOccurance).optional().default("EXTANT"),
...
export const natureQuerySchema = createPaginatedQuerySchema(
  ...
  "updatedAt",
  {
    ...
    occurance: z.nativeEnum(NatureOccurance).optional(),
  },
);
