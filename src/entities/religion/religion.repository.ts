            ...
            return {
                ...
                error:
                    error instanceof Error
                        ? error
                        : new DatabaseError("Failed to create religion", new Error(String(error))),
            };
        }
    }
        ...
        try {
            ...
            return {
                ...
                error:
                    error instanceof Error
                        ? error
                        : new DatabaseError("Failed to update religion", new Error(String(error))),
            };
        }
    }
        ...
        try {
            ...
            return {
                ...
                error:
                    error instanceof Error
                        ? error
                        : new DatabaseError("Failed to delete religion", new Error(String(error))),
            };
        }
    }
        ...
        try {
            ...
            return {
                ...
                error:
                    error instanceof Error
                        ? error
                        : new DatabaseError("Failed to find religions", new Error(String(error))),
            };
        }
    }
        ...
        try {
            ...
            return {
                ...
                error:
                    error instanceof Error
                        ? error
                        : new DatabaseError("Failed to find religion", new Error(String(error))),
            };
        }
    }

    async findOneWithRelations(id: string): Promise<Result<ReligionWithRelations>> {
        try {
            const result = await db.query.religions.findFirst({
                where: eq(religions.id, id),
                with: {
