...
export class ConstructController {
    ...
    async createConstruct(req: Request, res: Response): Promise<void> {
        ...
        const construct = await this.constructService.createConstruct(constructData, files);
    ...
    async updateConstruct(req: Request, res: Response): Promise<void> {
        ...
        const construct = await this.constructService.updateConstruct(constructId, constructData, files);
